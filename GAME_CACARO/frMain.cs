...
namespace GAME_CACARO
{
    public partial class frMain : Form
    {
        ...
        private const int CHESSMAN_PLAYER_A = 1;//gán 1 sẽ là giá trị quân cờ của người chơi 1
        ...
        private Color CHESSBOARD_COLOR = Color.Aqua;//màu của bàn cờ
        //
        ...
        private void pnCenter_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (isPlayWithPC)//nếu là chơi với máy
            {
                ...
                //sử dụng giải thuật MinMax áp dụng cho cờ caro - đã tham khảo trên mạng
        ...
        private Boolean isGameOver()//đây là hamg kiểm tra game đã kết thúc hay chưa
        {
            ...
            for (int rowChessboard = 0; rowChessboard < chessboard.Row; rowChessboard++)//sẽ duyệt trong mảng bàn cờ hàng ngang, đường chéo ,cột dọc,
        ...
        #endregion
        #region defence
        private long defenceScore_Row(int currRow, int currCell) //tính điểm phòng thủ của nước đi tiếp theo trên hàng ngang
        {
            long totalScore = 0;
            int numChessmanPlayerA = 0;
            int numChessmanPlayerB = 0;
